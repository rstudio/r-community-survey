...
## What Tools Do You Use With Python?  (Python Users Only)
...
lollipop_chart(top_15_items, 
          column_name = items, 
          fill_color = params$bar_colors, 
          subtitle_string = question_text("Qpython_tools", "(R users only)", 60),
          caption_string = paste0(survey_name, ", n = ", num_tool_responses))
plot_save("What Tools Do You Use With Python (Python Users Only).pdf")
```

## What Do You Use Python For? (Python users)
...
## Python Enjoyment (Python Users Only)
