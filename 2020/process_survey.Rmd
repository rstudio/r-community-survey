...
english_column_names <-
  read_csv(here::here("data/2020-question-names.txt"), col_names = "Question_name")
english_survey <-
  read_tsv(file = here::here("data/2020-english-survey-final2.tsv"),
           col_types = column_formats, col_names = english_column_names$Question_name)
english_survey$language <- "English"
spanish_survey <-
  read_tsv(here::here("data/2020-spanish-survey-final2.tsv"),
