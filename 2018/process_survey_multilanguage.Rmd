...
survey <- survey %>% 
  mutate(Qethnicity_coded = ifelse(Qethnicity_processed == "Prefer not to answer",
                                   NA, 
                                   Qethnicity_processed))
...
plot_save("Respondent Identified Genders (All Respondents).pdf", height = 2, width = 8, dpi=600)
```
...
plot_save("Respondent Ethnicities (All Respondents).pdf", height = 2.5, dpi=600)
...
unit_tests_use_dictionary <- read_delim("data/unit_test_use_dictionary.tsv", delim = "\t")
...
most_difficult_dictionary <- read_delim("data/difficult_aspect_dictionary.tsv", delim = "\t")
...
learning_times_dictionary <- read_delim("data/r_proficiency_dictionary.tsv", delim = "\t")
