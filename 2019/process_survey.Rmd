...
question_text <-
           ...
           wrap_length = 55)
  {
    ...
    if (str_length(question_text$Question_text) >= wrap_length) {
      return_text <-
        question_text$Question_text %>% str_wrap(width = wrap_length - 5)
    } else {
...
english_column_names <-
  read_tsv(here::here("data/survey-questions-2019-en.csv"))
english_survey <-
  read_tsv(here::here("data/2019 English R Community Survey Responses.tsv"),
           col_types = column_formats)
english_survey$language <- "English"
spanish_survey <-
  read_tsv(here::here("data/2019 Spanish R Community Survey Responses.tsv"),
           col_types = column_formats)
