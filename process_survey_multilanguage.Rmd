...
r_use_dictionary <- read_delim("data/use_dictionary.tsv", delim = "\t")
...
tidyverse_learned_dictionary <- read_delim("data/tidyverse_learned_dictionary.tsv", delim = "\t")
...
lollipop_chart(df                 = learned_with_tidyverse,
          ...
          fill_color             = params$bar_colors)
plot_save("Tidyverse Learning (R Users Only).pdf")
```

## Tidyverse Use (R Users Only)

```{r tidyverse, echo = TRUE}
tidyverse_use_dictionary <- read_delim("data/tidyverse_use_dictionary.tsv", delim = "\t")
...
```{r shiny, echo = TRUE}
shiny_use_dictionary <- read_delim("data/shiny_use_dictionary.tsv", delim = "\t")
...
version_control_use_dictionary <- read_delim("data/version_control_dictionary.tsv", delim = "\t")
...
lollipop_chart(df                 = using_version_control,
          ...
          fill_color              = params$bar_colors)
plot_save("Version_control Use Frequency Today (R Users Only).pdf")
```
