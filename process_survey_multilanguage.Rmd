...
bar_chart(df                 = r_proficiency,
          ...
          title_string           = "Time To Achieve Proficiency In R",
...
bar_chart(df                 = r_why,
          ...
          title_string           = "Reason To Learn R",
...
ggplot(recommend_scores) +
  ...
  scale_x_continuous(breaks = 1:10) +
    labs(title = question_text("Qrecommend"),
       ...
       caption = paste0(survey_name, ", n = ", responses),
       x="Score", y="Count")
```
